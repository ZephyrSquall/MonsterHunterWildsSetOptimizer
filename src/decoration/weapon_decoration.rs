...
pub const ALL_WEAPON_DECORATIONS: [&Decoration; 295] = [
    &ATTACK_JEWEL,
    &ATTACK_JEWEL_II,
    &ATTACK_JEWEL_III,
    &GUARDIAN_JEWEL,
    ...
    &GUARDIAN_BOLT_JWL,
    &GUARDIAN_DRAGON_JWL,
    &GUARDIAN_HANDICRAFT_JWL,
    &GUARDIAN_IRONWALL_JWL,
    &EXPERT_JEWEL,
    &EXPERT_JEWEL_II,
    &EXPERT_JEWEL_III,
    &CRITICAL_JEWEL,
    ...
    &BLAZE_JEWEL_II,
    &BLAZE_JEWEL_III,
    &BLAZE_GUARDIAN_JEWEL,
    &BLAZE_CRIT_ELEM_JWL,
    &BLAZE_HANDICRAFT_JWL,
    &BLAZE_RZR_SHARP_JWL,
    &BLAZE_PRECISE_JEWEL,
    &BLAZE_OPENER_JEWEL,
    &BLAZE_BANDOLIER_JWL,
    ...
    &STREAM_JEWEL_III,
    &STREAM_GUARDIAN_JWL,
    &STREAM_CRIT_ELEM_JWL,
    &STREAM_HANDICRAFT_JWL,
    &STREAM_RZR_SHARP_JWL,
    &STREAM_PRECISE_JEWEL,
    &STREAM_OPENER_JWL,
    &STREAM_BANDOLIER_JWL,
    &STREAM_FOCUS_JEWEL,
    &STREAM_ENHANCER_JWL,
    &STREAM_KO_JEWEL,
    &STREAM_QUICKSWITCH_JWL,
    &STREAM_IRONWALL_JWL,
    &STREAM_SHIELD_JEWEL,
    &BOLT_JEWEL,
    &BOLT_JEWEL_II,
    ...
    &DRAGON_JEWEL_III,
    &DRAGON_GUARDIAN_JWL,
    &DRAGON_CRIT_ELEM_JWL,
    &DRAGON_HANDICRAFT_JWL,
    &DRAGON_RZR_SHARP_JWL,
    &DRAGON_PRECISE_JEWEL,
    &DRAGON_OPENER_JEWEL,
    &DRAGON_BANDOLIER_JWL,
    &DRAGON_FOCUS_JEWEL,
    &DRAGON_ENHANCER_JWL,
    &DRAGON_KO_JEWEL,
    &DRAGON_QUICKSWITCH_JWL,
    &DRAGON_IRONWALL_JWL,
    &DRAGON_SHIELD_JEWEL,
    &VENOM_JEWEL,
    &VENOM_JEWEL_II,
    ...
    &BLAST_JEWEL_III,
    &CRIT_ELEMENT_JEWEL,
    &CRIT_ELEMENT_JEWEL_II,
    &CRIT_ELEM_JWL_III,
    &CRIT_ELEM_BLAZE_JWL,
    &CRIT_ELEM_STREAM_JWL,
    &CRIT_ELEM_FROST_JWL,
    &CRIT_ELEM_BOLT_JWL,
    &CRIT_ELEM_DRAGON_JWL,
    &CRIT_ELEM_HANDICRAFT_JWL,
    &CRIT_ELEM_PRECISE_JWL,
    &CRIT_ELEM_KO_JEWEL,
    &CRIT_ELEM_IRONWALL_JWL,
    &CRIT_STATUS_JEWEL,
    &CRIT_STATUS_JEWEL_II,
    &CRIT_STAT_JWL_III,
    &CRIT_STAT_HANDICRAFT_JWL,
    &CRIT_STAT_PRECISE_JWL,
    &CRIT_STATUS_KO_JWL,
    &CRIT_STAT_IRONWALL_JWL,
    &CHARGE_JEWEL,
    &CHARGE_JEWEL_II,
    &CHARGE_JEWEL_III,
    &CHARGE_HANDICRAFT_JWL,
    &CHARGE_KO_JEWEL,
    &HANDICRAFT_JEWEL,
    &HANDICRAFT_JEWEL_II,
    &HANDICRAFT_JWL_III,
    &RAZOR_SHARP_JEWEL,
    &RAZOR_SHARP_JEWEL_II,
    &RZR_SHARP_JWL_III,
    &RZR_SHARP_BLAZE_JWL,
    &RZR_SHARP_STREAM_JWL,
    &RZR_SHARP_FROST_JWL,
    &RZR_SHARP_BOLT_JWL,
    &RZR_SHARP_DRAGON_JWL,
    &RZR_SHARP_HANDICRAFT_JWL,
    &RAZOR_SHARP_KO_JWL,
    &RZR_SHARP_IRONWALL_JWL,
    &SHARP_JEWEL,
    &SHARP_JEWEL_II,
    &SHARP_JEWEL_III,
    &MINDS_EYE_JEWEL,
    ...
    &OPENER_BOLT_JEWEL,
    &OPENER_DRAGON_JEWEL,
    &OPENER_PRECISE_JEWEL,
    &OPENER_IRONWALL_JWL,
    &BANDOLIER_JEWEL,
    &BANDOLIER_JEWEL_II,
    &BANDOLIER_JEWEL_III,
    &BANDOLIER_BLAZE_JWL,
    &BANDOLIER_STREAM_JWL,
    &BANDOLIER_FROST_JWL,
    &BANDOLIER_BOLT_JWL,
    &BANDOLIER_DRAGON_JWL,
    &BANDOLIER_PRECISE_JWL,
    &BANDOLIER_IRONWALL_JWL,
    &TRUESHOT_JEWEL,
    &TRUESHOT_JEWEL_II,
    &POISONCOAT_JEWEL,
    &PARACOAT_JEWEL,
    ...
    &FOCUS_BOLT_JWL,
    &FOCUS_DRAGON_JEWEL,
    &FOCUS_HANDICRAFT_JEWEL,
    &FOCUS_PRECISE_JEWEL,
    &FOCUS_KO_JEWEL,
    &ENHANCER_JEWEL,
    &ENHANCER_JEWEL_II,
    &ENHANCER_JEWEL_III,
    &ENHANCER_BLAZE_JEWEL,
    &ENHANCER_STREAM_JWL,
    &ENHANCER_FROST_JWL,
    &ENHANCER_BOLT_JEWEL,
    &ENHANCER_DRAGON_JWL,
    &ENHANCER_HANDICRAFT_JWL,
    &GAMBIT_JEWEL,
    &GAMBIT_JEWEL_II,
    &GAMBIT_JEWEL_III,
    &GAMBIT_HANDICRAFT_JWL,
    &GAMBIT_KO_JEWEL,
    &GAMBIT_IRONWALL_JWL,
    &KO_JEWEL,
    &KO_JEWEL_II,
    ...
    &ARTILLERY_JEWEL_III,
    &QUICKSWITCH_JEWEL,
    &QUICKSWITCH_JEWEL_II,
    &QUICKSWITCH_JEWEL_III,
    &QUICKSWITCH_BLAZE_JWL,
    &QUICKSWITCH_STREAM_JWL,
    &QUICKSWITCH_FROST_JWL,
    &QUICKSWITCH_BOLT_JWL,
    &QUICKSWITCH_DRAGON_JWL,
    &QUICKSWITCH_HANDICRAFT_JWL,
    &QUICKSWITCH_KO_JWL,
    &QUICKSWITCH_IRONWALL_JWL,
    &SONOROUS_JEWEL,
    &SONOROUS_ATTACK_JWL,
    &SONOROUS_EXPERT_JWL,
    &SONOROUS_DRAW_JWL,
    &SONOROUS_HANDICRAFT_JWL,
    &SONOROUS_KO_JEWEL,
    &CHARGE_UP_JEWEL,
    &CHARGE_UP_ATTACK_JWL,
    &CHARGE_UP_EXPERT_JWL,
    &CHARGE_UP_DRAW_JWL,
    &CHARGE_UP_HANDICRAFT_JWL,
    &CHARGE_UP_KO_JEWEL,
    &FLIGHT_JEWEL,
    &FLIGHT_ATTACK_JWL,
    &FLIGHT_EXPERT_JEWEL,
    &FLIGHT_DRAW_JEWEL,
    &FLIGHT_HANDICRAFT_JWL,
    &POISON_JEWEL,
    &POISON_ATTACK_JEWEL,
    &POISON_EXPERT_JWL,
    &POISON_DRAW_JEWEL,
    &POISON_HANDICRAFT_JWL,
    &POISON_PRECISE_JWL,
    &POISON_KO_JEWEL,
    &POISON_IRONWALL_JWL,
    &IRONWALL_JEWEL,
    ...
    &MAGAZINE_EXPERT_JWL,
    &MAGAZINE_DRAW_JWL,
    &MAGAZINE_HANDICRAFT_JWL,
    &MAGAZINE_IRONWALL_JWL,
    &GRINDER_JEWEL,
    &GRINDER_JEWEL_II,
    &GRINDER_ATTACK_JEWEL,
    &GRINDER_EXPERT_JEWEL,
    &GRINDER_DRAW_JEWEL,
    &GRINDER_HANDICRAFT_JWL,
    &GRINDER_KO_JEWEL,
    &GRINDER_IRONWALL_JEWEL,
];
